...
//     const tid = String(this.teamIdSignal()).trim();

//     if (!tid) return allProjects;

//     return allProjects.filter(p => {
//       // בדיקה יצירתית: אנחנו בודקים גם team_id וגם teamId ליתר ביטחון
//       const projectTid = String(p.team_id || p.team_id || '').trim();
//       return projectTid === tid;
//     });
//   });
...
//     console.log('--- בדיקת ID של צוות ---');
//     console.log('ה-ID שנשלף מהכתובת:', id);
//     console.log('הסוג שלו:', typeof id);
...
//     this.projectsService.addProject(teamId, nameVal, descVal).subscribe({
//       next: (res) => {
//         // יצירתיות! השרת מחזיר לנו את האובייקט החדש שנוצר
//         // אנחנו מוסיפים אותו ידנית לרשימה כדי שהוא יופיע בשנייה זו על המסך
//         const projectWithId = {
//           ...res, // הנתונים שהשרת החזיר (כולל ה-ID החדש)
//           team_id: teamId, // מוודאים שה-ID של הצוות תואם לסינון שלנו
//           name: nameVal,
//           description: descVal
//         };

//         this.projectsService.addProjectToSignal(projectWithId);

//         alert('✅ בום! הפרויקט הופיע!');
//         this.isCreateOpen.set(false);
//         this.nameControl.reset();
//         this.descControl.reset();
//       },
//       error: (err) => alert('❌ שגיאה בשרת')
//     });
//   }
// }
